...
def tenxlargesvdeletions():
    ...
    sample_frame = sample_frame.loc[sample_frame['FILTER_PASS']==True].loc[sample_frame['QUAL']>scores_cutoff].loc[sample_frame['ALT_1']=='<DEL>']
    ...
    father_frame = father_frame.loc[father_frame['FILTER_PASS']==True].loc[father_frame['QUAL']>scores_cutoff].loc[father_frame['ALT_1']=='<DEL>']
    ...
    mother_frame = mother_frame.loc[mother_frame['FILTER_PASS']==True].loc[mother_frame['QUAL']>scores_cutoff].loc[mother_frame['ALT_1']=='<DEL>']
    ...
    ref_frame = ref_frame.loc[ref_frame['ALT_1']=='<DEL>']
    ...
    cytoband_calls.to_csv(args.outputdirectory+'10xLargeSvDeletions'+args.sampleID+'cytobands', sep='\t')
    exon_calls.to_csv(args.outputdirectory+'10xLargeSvDeletions'+args.sampleID+'exons', sep='\t')

tenxlargesvdeletions()
