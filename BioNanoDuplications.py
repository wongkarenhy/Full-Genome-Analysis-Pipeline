...
def duplication():
    ...
    cytoband_calls.to_csv(args.outputdirectory+'BioNanoDuplications'+args.sampleID+'cytobands', sep='\t')
    exon_calls.to_csv(args.outputdirectory+'BioNanoDuplications'+args.sampleID+'exons', sep='\t')
