...
def deletion():
    ...
    parent_frame = confident_pf[confident_pf['Type']=='deletion']
    ...
    cytoband_calls.to_csv(args.outputdirectory+'BioNanoDeletions'+args.sampleID+'cytobands', sep='\t')
    exon_calls.to_csv(args.outputdirectory+'BioNanoDeletions'+args.sampleID+'exons', sep='\t')
